...
from trainer import LSTMTrainer, CNNLSTMTrainer, FEDTrainer, TCNTrainer, TSTPTrainer, TimesFMTrainer, TimesFMTrainerConfig
...
def objective_timesfm(trial, cfg, X_raw, Y_raw, checkpoint_dir):
    ...
    import torch
    import os
    from trainer import TimesFMTrainer, TimesFMTrainerConfig
...
def objective(trial, cfg, X_raw, Y_raw, checkpoint_dir):
    ...
    if cfg.model.trainer_class == 'TimesFMTrainer':
